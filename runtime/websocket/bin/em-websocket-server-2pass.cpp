...
nlohmann::json handle_result(FUNASR_RESULT result) {
  ...
  jsonresult["text"] = "";
  jsonresult["action"] = "result";
  jsonresult["frame"] = "fun";
  jsonresult["segment"] = 1;
  ...
  switch (msg->get_opcode()) {
    case websocketpp::frame::opcode::text: {
      ...
      if (jsonresult.contains("itn")) {
        ...
        msg_data->msg["itn"] = true;  // default is true
      }
      ...
      if (!jsonresult.contains("is_speaking")) {
        jsonresult["is_speaking"] = true;
      }
      if (!jsonresult.contains("chunk_interval")) {
        jsonresult["chunk_interval"] = 10;
      }
